...
class C(BaseConstants):
    ...
    VALOR_MAXIMO = 0 # Cada jugador podrá colocar un valor entre 0 y 100
...
class Group(BaseGroup):
    dos_tercios_promedio =  # Para almacenar los dos tercios del promedio
    mejor_estimacion =  # Para almacenar la mejor estimación de los jugadores
    n_ganadores =  # Para almacenar la cantidad de ganadores
